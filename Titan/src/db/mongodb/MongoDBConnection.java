...
//Mongodb:  db.users.update({user_id:userId},{$pullAll:{favorite:itemIds}})
	...
	@Override
	public void loginUsers(String userId, String password, String first_name, String last_name) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void loginUsers(String userId, String password, String first_name, String last_name, String nation,
